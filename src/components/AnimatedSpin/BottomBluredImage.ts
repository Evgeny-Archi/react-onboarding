...
const HIDDEN_IMAGE_OFFSET = '-50px, -120px';
const ACTIVE_IMAGE_OFFSET = '50px, 120px';
...
const BottomBluredImage = styled.img`
    width: 60px;
    height: auto;
    position: absolute;
    top: 230px;
...
export default withSlideTransition<HTMLImageElement>(BottomBluredImage);
